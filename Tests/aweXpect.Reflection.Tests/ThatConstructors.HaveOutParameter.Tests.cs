	...
	public sealed class HaveOutParameter
	{
		...
		public sealed class Tests
		{
			...
			public async Task ByName_WhenNotAllHaveOutParameter_ShouldFail()
			{
				...
				{
					typeof(ClassWithOutParameter).GetConstructors().Single(), typeof(ClassWithoutModifiers).GetConstructors().Single(),
				};
			...
			public async Task WhenAllHaveOutParameter_ShouldSucceed()
			{
				IEnumerable<ConstructorInfo> constructors = new[]
				{
					typeof(ClassWithOutParameter).GetConstructors().Single(), typeof(AnotherClassWithOutParameter).GetConstructors().Single(),
				};
