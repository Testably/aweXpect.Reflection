...
public static partial class ThatMethods
{
	...
	/// </summary>
	public static AndOrResult<IEnumerable<MethodInfo?>, IThat<IEnumerable<MethodInfo?>>> HaveParamsParameter(
	...
	///     a <see langword="params" /> parameter.
	/// </summary>
	public static AndOrResult<IAsyncEnumerable<MethodInfo?>, IThat<IAsyncEnumerable<MethodInfo?>>> HaveParamsParameter(
...
#endif
	{
		...
		public async Task<ConstraintResult> IsMetBy(IAsyncEnumerable<MethodInfo?> actual,
			...
			=> await SetAsyncValue(actual, method => method?.GetParameters().Any(p => p.IsParamsParameter()) == true);
#endif

		public ConstraintResult IsMetBy(IEnumerable<MethodInfo?> actual)
			=> SetValue(actual, method => method?.GetParameters().Any(p => p.IsParamsParameter()) == true);
		...
		{
			stringBuilder.Append(it).Append(" contained methods without a params parameter ");
		...
		{
			stringBuilder.Append(it).Append(" only contained methods with a params parameter ");
