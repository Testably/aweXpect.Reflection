...
public static partial class ConstructorFilters
{
	...
	/// <summary>
	///     Filter for constructors with an <see langword="out" /> parameter of type <paramref name="parameterType" />.
	/// </summary>
	public static ConstructorsWithParameter<object?> WithOutParameter(this Filtered.Constructors @this, Type parameterType)
	...
	/// <summary>
	///     Filter for constructors with an <see langword="out" /> parameter of type <paramref name="parameterType" /> with the
	///     <paramref name="expected" /> name.
	/// </summary>
	public static ConstructorsWithNamedParameter<object?> WithOutParameter(this Filtered.Constructors @this, Type parameterType, string expected)
	...
	/// <summary>
	///     Filter for constructors with an <see langword="out" /> parameter of exact type <paramref name="parameterType" />.
	/// </summary>
	public static ConstructorsWithParameter<object?> WithOutParameterExactly(this Filtered.Constructors @this, Type parameterType)
		=> @this.WithParameterExactly(parameterType).WithModifier(p => p.IsOutParameter(), "with out modifier");

	/// <summary>
	///     Filter for constructors with an <see langword="out" /> parameter of exact type <paramref name="parameterType" /> with the
	///     <paramref name="expected" /> name.
	/// </summary>
	public static ConstructorsWithNamedParameter<object?> WithOutParameterExactly(this Filtered.Constructors @this, Type parameterType, string expected)
