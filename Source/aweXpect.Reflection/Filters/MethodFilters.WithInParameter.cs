...
public static partial class MethodFilters
{
	...
	/// <summary>
	///     Filter for methods with an <see langword="in" /> parameter of type <paramref name="parameterType" />.
	/// </summary>
	public static MethodsWithParameter<object?> WithInParameter(this Filtered.Methods @this, Type parameterType)
	...
	/// <summary>
	///     Filter for methods with an <see langword="in" /> parameter of type <paramref name="parameterType" /> with the
	///     <paramref name="expected" /> name.
	/// </summary>
	public static MethodsWithNamedParameter<object?> WithInParameter(this Filtered.Methods @this, Type parameterType, string expected)
	...
	/// <summary>
	///     Filter for methods with an <see langword="in" /> parameter of exact type <typeparamref name="T" />.
	/// </summary>
	public static MethodsWithParameter<T> WithInParameterExactly<T>(this Filtered.Methods @this)
		=> @this.WithParameterExactly<T>().WithModifier(p => p.IsInParameter(), "with in modifier");

	/// <summary>
	///     Filter for methods with an <see langword="in" /> parameter of exact type <paramref name="parameterType" />.
	/// </summary>
	public static MethodsWithParameter<object?> WithInParameterExactly(this Filtered.Methods @this, Type parameterType)
		=> @this.WithParameterExactly(parameterType).WithModifier(p => p.IsInParameter(), "with in modifier");

	/// <summary>
	///     Filter for methods with an <see langword="in" /> parameter of exact type <typeparamref name="T" /> with the
	///     <paramref name="expected" /> name.
	/// </summary>
	public static MethodsWithNamedParameter<T> WithInParameterExactly<T>(this Filtered.Methods @this, string expected)
		=> @this.WithParameterExactly<T>(expected).WithModifier(p => p.IsInParameter(), "with in modifier");

	/// <summary>
	///     Filter for methods with an <see langword="in" /> parameter of exact type <paramref name="parameterType" /> with the
	///     <paramref name="expected" /> name.
	/// </summary>
	public static MethodsWithNamedParameter<object?> WithInParameterExactly(this Filtered.Methods @this, Type parameterType, string expected)
